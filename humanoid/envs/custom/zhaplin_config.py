...
class ZhaplinCfg(XBotLCfg):
    ...
    class asset(XBotLCfg.asset):
        ...
        for lr, name in product(['right', 'left'], ["shoulder-pitch", "shoulder-roll", "shoulder-yaw", "elbow-pitch"]):
            terminate_after_contacts_on.append(f'{lr}-{name}')
    ...
    class init_state(XBotLCfg.init_state):
        ...
        "left-shoulder-pitch": 0.,
        "left-shoulder-roll": 0., 
        "left-shoulder-yaw":0.,
        "left-elbow-pitch" :0.,
        "right-shoulder-pitch":0.,
        "right-shoulder-roll":0.,
        "right-shoulder-yaw":0.,
        "right-elbow-pitch" :0.,
        "waist-yaw":0.,
        "left-hip-pitch":0.,
        "left-hip-roll":0.,
    ...
    class control(XBotLCfg.control):
        ...
        "left-shoulder-yaw":30.,
        "left-elbow-pitch" :30.,
        "right-shoulder-pitch":30.,
        "right-shoulder-roll":30.,
        "right-shoulder-yaw":30.,
        "right-elbow-pitch" :30.,
        "waist-yaw":30.,
        "left-hip-pitch":30.,
        "left-hip-roll":30.,
        "left-hip-yaw":30.,
        ...
        damping = { 
        "left-shoulder-pitch": 3.,
        "left-shoulder-roll": 3., 
        "left-shoulder-yaw":3.,
        "left-elbow-pitch" :3.,
        "right-shoulder-pitch":3.,
        "right-shoulder-roll":3.,
        "right-shoulder-yaw":3.,
        "right-elbow-pitch" :3.,
        "waist-yaw":3.,
        "left-hip-pitch":3.,
        "left-hip-roll":3.,
...
class ZhaplinCfgPPO(XBotLCfgPPO):
    seed = 5
